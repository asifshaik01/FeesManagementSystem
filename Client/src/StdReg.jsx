...
//             try {
//                 const response = await axios.get('https://fees-management-system.onrender.com/getAllMentors');
...
//         e.preventDefault();
//         await axios.post('https://fees-management-system.onrender.com/stdreg', {
//             name,
//             roll,
//             admission,
//             isjvd,
...
function StdReg() {
    ...
    const handleRollCheck = async () => {
        try {
            const response = await axios.get('https://fees-management-system.onrender.com/checkRoll', {
                params: { roll }
            });
    ...
    const handleClick = async (e) => {
        e.preventDefault();
        const rollExists = await handleRollCheck();
        if (rollExists) {
    ...
    return (
        <div id="container">
            ...
            <form id="feeForm">
                ...
                <b><label htmlFor="universityfee">University Fee:</label></b>
                <input type="number" id="universityfee" value={universityfee} name="universityFee" readOnly />

                <b><label htmlFor="skilldevfee">Skill Development Fee:</label></b>
                <input type="number" id="skilldevfee" name="skilldevfee" value={skilldevfee} readOnly />
